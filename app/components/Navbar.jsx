...
useEffect(()=>{
  ...
  return (
    ...
    <nav className={`w-full fixed top-0 left-0 px-5 lg:px-8 xl:px-[8%] py-4 flex items-center 
        justify-between   z-50 ${isScroll? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm": ""}`}>

      <a  href='#top'>
            <video src="/logo-nandana.mp4" autoPlay loop muted className="w-30 cursor-pointer mr-14"></video>
        </a>
